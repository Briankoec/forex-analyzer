...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-forex-analyzer-secret-key-change-in-production')
...
ROOT_URLCONF = 'forex_analyzer.urls'
...
WSGI_APPLICATION = 'forex_analyzer.wsgi.application'
